                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-white flex items-center gap-2">
                                <Users size={20} className="text-sky-400" /> Edit User
                            </h1>
                            <p className="text-xs text-slate-400 mt-0.5">Leave password blank to keep current password</p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-lg">
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <Field label="New Password (optional)" error={errors.password}>
                                <input type="password" className={inputCls} placeholder="Leave blank to keep current" value={data.password} onChange={e => setData('password', e.target.value)} />
                            </Field>
                            <Field label="Confirm New Password">
                                <input type="password" className={inputCls} placeholder="Repeat new password" value={data.password_confirmation} onChange={e => setData('password_confirmation', e.target.value)} />
                            </Field>
